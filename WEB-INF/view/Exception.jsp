...
<div class="container">
        <div class="error">
                    ...
                    <a class="nav-link active fas fa-laptop-house" aria-current="page" href="/PowerOfEducation/">Home</a>
           <h1 style="color:red">This is Error Which created by us ${errorMsg }</h1>
        </div>
